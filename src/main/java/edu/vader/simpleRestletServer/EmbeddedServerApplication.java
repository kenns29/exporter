package edu.vader.simpleRestletServer;
...
public class EmbeddedServerApplication extends Application {
    ...
    public Restlet createInboundRoot() {
        ...
        router.attach("/status", edu.vader.simpleRestletServer.resources.Status.class);
        router.attach("/progress", edu.vader.simpleRestletServer.resources.Progress.class);
